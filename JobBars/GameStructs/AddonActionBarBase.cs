...
namespace JobBars.GameStructs {
    ...
    public unsafe struct AddonActionBarCross {
        ...
        public readonly bool GetCompact( out int set, out bool left ) {
            set = -1;
            left = false;
        ...
        public readonly bool GetCompactLeft( out int set, out bool left ) => GetSelectedCompact( LeftCompactFlags, out set, out left );
        public readonly bool GetCompactRight( out int set, out bool left ) => GetSelectedCompact( RightCompactFlags, out set, out left );
